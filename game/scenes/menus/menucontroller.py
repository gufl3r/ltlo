import game.scenes.menus.main.main as main_scene
import game.scenes.menus.settings.settings as settings_scene
import game.scenes.menus.credits.credits as credits_scene
import engine.systems.global_.loading as loading_system
